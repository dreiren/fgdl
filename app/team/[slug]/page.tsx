...
export async function generateMetadata({
  ...
  return {
    title: attorney.name,
    description: `${attorney.role} at FGDLaw. ${attorney.cardSummary}`,
  };
}
  ...
  return (
    <>
      <PageHero
        ...
        title={attorney.name}
        description={attorney.cardSummary}
      />
      <section className="bg-cream py-16 md:py-20">
        <Container className="grid gap-10 lg:grid-cols-[0.35fr_0.65fr]">
          <div className="overflow-hidden rounded-2xl bg-white shadow-[0_8px_30px_rgba(8,21,38,0.04)]">
